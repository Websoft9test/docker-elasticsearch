...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r elasticsearch
```
### package install
...
```
sudo wget -N https://raw.githubusercontent.com/Websoft9/StackHub/main/docker-installer.sh; sudo bash docker-installer.sh -r elasticsearch -p
```
...
```
sudo bash install-elasticsearch
```
...
```
git clone --depth=1 https://github.com/Websoft9/docker-elasticsearch
...
[Elasticsearch Administrator Guide](https://support.websoft9.com/docs/elasticsearch)

## Enterprise Support

If you want to get our Enterprise Support to ensure high availability of applications, you can subscribe our [Elasticsearch Enterprise Support](https://apps.websoft9.com/elasticsearch) 
